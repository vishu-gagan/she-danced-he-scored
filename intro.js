...
(function(){
  ...
  function startOpenSequence(){
    ...
    // no pause after zoom (zoom is 6s starting at 3300ms = 9300ms complete, reveal immediately)
    scheduleAfter(9300, function(){ intro.classList.add('reveal'); });
    scheduleAfter(10150, finish);
  }
